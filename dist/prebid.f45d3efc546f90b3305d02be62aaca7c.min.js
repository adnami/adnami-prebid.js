...
pbjsChunk([123],{75:function(e,n,t){t(76),e.exports=t(77)},76:function(e,n,t){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.spec=void 0;var r=t(1),h=t(3),s=n.spec={code:"adform",supportedMediaTypes:[h.BANNER,h.VIDEO],isBidRequestValid:function(e){return!!e.params.mid},buildRequests:function(e,n){var t,r,s,d,i,o,a,p,u,c=[],h=[["adxDomain","adx.adform.net"],["fd",1],["url",null],["tid",null]],l=JSON.parse(JSON.stringify(e));for(t=0,r=l.length;t<r;t++){for("net"!==(i=l[t]).params.priceType&&"net"!==i.params.pt||(u="net"),s=0,d=h.length;s<d;s++)(a=i[o=h[s][0]]||i.params[o])&&(i[o]=i.params[o]=null,h[s][1]=a);(p=i.params).transactionId=i.transactionId,c.push(f(p))}for(c.unshift("//"+h[0][1]+"/adx/?rp=4"),u=u||"gross",c.push("pt="+u),c.push("stid="+e[0].auctionId),n&&n.gdprConsent&&(c.push("gdpr="+n.gdprConsent.gdprApplies),c.push("gdpr_consent="+n.gdprConsent.consentString)),t=1,r=h.length;t<r;t++)o=h[t][0],(a=h[t][1])&&c.push(o+"="+encodeURIComponent(a));return{method:"GET",url:c.join("&"),bids:e,netRevenue:u,bidder:"adform"};function f(e){var n,t=[];for(n in e)e.hasOwnProperty(n)&&e[n]&&t.push(n,"=",e[n],"&");return encodeURIComponent(btoa(t.join("").slice(0,-1)))}},interpretResponse:function(e,n){for(var t,r,s,d,i={banner:1,vast_content:1,vast_url:1},o=[],a=n.bids,p=e.body,u=0;u<p.length;u++)d="banner"===(r=p[u]).response?h.BANNER:h.VIDEO,s=a[u],i[r.response]&&(c(r,s.sizes)||d===h.VIDEO)&&(t={requestId:s.bidId,cpm:r.win_bid,width:r.width,height:r.height,creativeId:s.bidId,dealId:r.deal_id,currency:r.win_cur,netRevenue:"gross"!==n.netRevenue,ttl:360,ad:r.banner,bidderCode:n.bidder,transactionId:s.transactionId,vastUrl:r.vast_url,vastXml:r.vast_content,mediaType:d},o.push(t));return o;function c(e,n){for(var t=0,r=n.length;t<r;t++)if(e.width===n[t][0]&&e.height===n[t][1])return!0;return!1}}};(0,r.registerBidder)(s)},77:function(e,n){}},[75]);
